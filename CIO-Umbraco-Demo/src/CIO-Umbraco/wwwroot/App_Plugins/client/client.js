...
var t$2 = globalThis, e$1 = t$2.ShadowRoot && (t$2.ShadyCSS === void 0 || t$2.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, s$2 = Symbol(), o$4 = /* @__PURE__ */ new WeakMap(), n$2 = class {
	...
	get styleSheet() {
		...
		if (e$1 && x === void 0) {
			...
			j && (x = o$4.get(F)), x === void 0 && ((this.o = x = new CSSStyleSheet()).replaceSync(this.cssText), j && o$4.set(F, x));
		}
		return x;
	}
	toString() {
...
}, r$2 = (x) => new n$2(typeof x == "string" ? x : x + "", void 0, s$2), i$1 = (x, ...j) => new n$2(x.length === 1 ? x[0] : j.reduce((j, F, U) => j + ((x) => {
	...
	return r$2(j);
})(x) : x, { is: i$3, defineProperty: e$2, getOwnPropertyDescriptor: h$1, getOwnPropertyNames: r$3, getOwnPropertySymbols: o$3, getPrototypeOf: n$3 } = Object, a$1 = globalThis, c$2 = a$1.trustedTypes, l$1 = c$2 ? c$2.emptyScript : "", p$1 = a$1.reactiveElementPolyfillSupport, d$1 = (x, j) => x, u = {
	toAttribute(x, j) {
		switch (j) {
			case Boolean:
				x = x ? l$1 : null;
...
var y = class extends HTMLElement {
	...
	static finalize() {
		...
		if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(d$1("properties"))) {
			let x = this.properties, j = [...r$3(x), ...o$3(x)];
...
var N = (x, j) => {
	...
	for (let j = 0; j < F; j++) {
		...
		G += K === v ? F + r$1 : Y >= 0 ? (U.push(q), F.slice(0, Y) + h + F.slice(Y) + o$2 + Q) : F + o$2 + (Y === -2 ? j : Q);
	}
...
function n(x) {
	return (j, F) => typeof F == "object" ? r(x, j, F) : ((x, j, F) => {
...
var MyElement = class extends i {
	constructor(...x) {
		super(...x), this.docsHint = "Click on the Vite and Lit logos to learn more", this.count = 0;
	}
	render() {
		return b`
      <div>
...
__decorate([n()], MyElement.prototype, "docsHint", void 0), __decorate([n({ type: Number })], MyElement.prototype, "count", void 0), MyElement = __decorate([t("my-element")], MyElement);
export { MyElement };
