const O = globalThis, D = O.ShadowRoot && (O.ShadyCSS === void 0 || O.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, L = /* @__PURE__ */ Symbol(), V = /* @__PURE__ */ new WeakMap();
let tt = class {
  constructor(t, e, s) {
...
const ot = (r) => new tt(typeof r == "string" ? r : r + "", void 0, L), ht = (r, ...t) => {
...
const { is: lt, defineProperty: ct, getOwnPropertyDescriptor: dt, getOwnPropertyNames: pt, getOwnPropertySymbols: ut, getPrototypeOf: $t } = Object, M = globalThis, q = M.trustedTypes, _t = q ? q.emptyScript : "", ft = M.reactiveElementPolyfillSupport, b = (r, t) => r, R = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? _t : null;
      break;
  ...
  return e;
} }, et = (r, t) => !lt(r, t), F = { attribute: !0, type: String, converter: R, reflect: !1, useDefault: !1, hasChanged: et };
...
let g = class extends HTMLElement {
  ...
  requestUpdate(t, e, s, i = !1, n) {
    if (t !== void 0) {
      ...
      if (i === !1 && (n = this[t]), s ??= o.getPropertyOptions(t), !((s.hasChanged ?? et)(n, e) || s.useDefault && s.reflect && n === this._$Ej?.get(t) && !this.hasAttribute(o._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
...
g.elementStyles = [], g.shadowRootOptions = { mode: "open" }, g[b("elementProperties")] = /* @__PURE__ */ new Map(), g[b("finalized")] = /* @__PURE__ */ new Map(), ft?.({ ReactiveElement: g }), (M.reactiveElementVersions ??= []).push("2.1.2");
const j = globalThis, J = (r) => r, H = j.trustedTypes, Z = H ? H.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, st = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, it = "?" + _, At = `<${it}>`, m = document, w = () => m.createComment(""), C = (r) => r === null || typeof r != "object" && typeof r != "function", z = Array.isArray, mt = (r) => z(r) || typeof r?.[Symbol.iterator] == "function", T = `[ 	
\f\r]`, E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, K = /-->/g, G = />/g, f = RegExp(`>|${T}(?:([^\\s"'>=/]+)(${T}*=${T}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Q = /'/g, X = /"/g, rt = /^(?:script|style|textarea|title)$/i, gt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), yt = gt(1), y = /* @__PURE__ */ Symbol.for("lit-noChange"), d = /* @__PURE__ */ Symbol.for("lit-nothing"), Y = /* @__PURE__ */ new WeakMap(), A = m.createTreeWalker(m, 129);
function nt(r, t) {
...
const vt = (r, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const h = r[l];
    let c, p, a = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === E ? p[1] === "!--" ? o = K : p[1] !== void 0 ? o = G : p[2] !== void 0 ? (rt.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = f) : p[3] !== void 0 && (o = f) : o === f ? p[0] === ">" ? (o = i ?? E, a = -1) : p[1] === void 0 ? a = -2 : (a = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? f : p[3] === '"' ? X : Q) : o === X || o === Q ? o = f : o === K || o === G ? o = E : (o = f, i = void 0);
    const $ = o === f && r[l + 1].startsWith("/>") ? " " : "";
    n += o === E ? h + At : a >= 0 ? (s.push(c), h.slice(0, a) + st + h.slice(a) + _ + $) : h + _ + (a === -2 ? l : $);
  }
    ...
    for (; (i = A.nextNode()) !== null && h.length < l; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const a of i.getAttributeNames()) if (a.endsWith(st)) {
          ...
          h.push({ type: 1, index: n, name: U[2], strings: $, ctor: U[1] === "." ? bt : U[1] === "?" ? St : U[1] === "@" ? wt : N }), i.removeAttribute(a);
...
class x {
  ...
  _$AI(t, e = this) {
    t = v(this, t, e), C(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== y && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : mt(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
Pt?.(P, x), (j.litHtmlVersions ??= []).push("3.3.2");
const xt = (r, t, e) => {
...
const B = class B extends S {
  constructor() {
    super(...arguments), this.forms = [], this.loading = !0, this.error = "";
  }
...
B.styles = ht`
  ...
  `;
let k = B;
customElements.define("custom-forms-dashboard", k);
export {
  k as CustomFormsDashboard
};
